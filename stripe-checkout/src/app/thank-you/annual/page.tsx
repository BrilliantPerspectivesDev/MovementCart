...
function ThankYouContent() {
  ...
  useEffect(() => {
    ...
    const pollForLoginDetails = async () => {
      try {
        const response = await fetch(`/api/webhook/annual?subscriptionId=${subscriptionId}`);
          ...
          <div className="p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">
                Thank you for becoming an Annual Member. Your journey to making Kingdom normal starts now.
              </p>
            </div>
...
export default function AnnualThankYou() {
  return (
