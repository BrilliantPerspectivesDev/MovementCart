...
function CheckoutForm({
    ...
    switch (name) {
      ...
      case 'zipCode':
        ...
        if (formData.country === 'US') {
          ...
          // For international, allow letters, numbers, spaces, and hyphens
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
      ...
      {/* Render progress steps */}
        ...
        <div className="space-y-3 md:space-y-4">
          ...
          <div className="space-y-2">
            <label htmlFor="card-element" className="block text-xs md:text-sm font-medium text-gray-700 mb-1">
              Credit Card
            </label>
      ...
      <button
        type="submit"
        className="w-full py-2 md:py-3 px-3 md:px-4 border border-transparent rounded-md shadow-sm text-sm md:text-base font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Auto-renews monthly after trial</p>
                  </div>
                  <input
                    type="radio"
                    name="plan"
              ...
              >
                ...
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Auto-renews yearly after trial</p>
