...
function SuccessContent() {
  ...
  const price = plan === 'monthly' ? '$47/month' : plan === 'annual' ? '$397/year' : 'Unknown';
        ...
        <div className="flex-1 md:w-3/5 bg-white p-4 md:p-8 lg:p-12 overflow-auto">
          <div className="max-w-lg mx-auto">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-[#264653]">
                    {plan === 'monthly' ? 'Monthly Member' : plan === 'annual' ? 'Annual Member' : 'Member'}
                  </span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="text-center mt-8">
              <Link
                href="/dashboard"
                className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-[#74A78E] hover:bg-[#74A78E]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#74A78E]"
              >
                Go to Dashboard
              </Link>
            </div>
